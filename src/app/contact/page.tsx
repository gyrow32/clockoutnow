                ...
                <div className="card p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        <div className="text-sm font-medium text-charcoal-700">Try Our AI Agent</div>
                        <div className="text-sm font-semibold text-green-600">(607) 225-3400</div>
                      </div>
                    </a>
                    <a
